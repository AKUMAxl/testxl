...
public interface ISSErrors {
	...
	public static final int ISS_ERROR_AIUI_CLIENT_NOT_READY			= 10022;		/**< AIUI client is not ready. */
    ...
    public static final int ISS_ERROR_INVALID_DIR                   = 10131;     /* 0x2793 */        /* 无效文件夹 */
    public static final int ISS_ERROR_PARENT_PATH_NOT_SAME          = 10132;     /* 0x2794 */        /* 路径冲突 */
    public static final int ISS_ERROR_MVW_LANG_CONFLICT             = 10133;     /* 0x2795 */        /* 语种冲突 */
    public static final int ISS_ERROR_CREATE_DIRECTORY              = 10134;     /* 0x2796 */        /* 创建文件夹失败 */
    public static final int ISS_ERROR_MVW_START_ENGINE              = 10135;     /* 0x2797 */        /* 启动唤醒引擎失败 */
    public static final int ISS_ERROR_MVW_CFG_FILE                  = 10136;     /* 0x2798 */        /* 加载或者解析唤醒配置文件失败，恢复至默认的配置文件 */
