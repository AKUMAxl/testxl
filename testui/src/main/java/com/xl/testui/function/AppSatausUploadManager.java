...
public class AppSatausUploadManager {
    ...
    public void init(Context context){
        DcsOpenAPI.getInstance().init(context, true, new IDcsServiceListener() {
            @Override
    ...
    /**
     * 检索结果状态上传 （美食，景点，酒店，停车场，导航POI检索到结果时需要上传）
    ...
    /**
     * 上传路线规划和导航状态(路线规划 导航中 非导航和路线规划状态 状态变化时需要上传)
     */
    ...
    /**
     * 上传前后台切换状态(酒店 美食 景点 导航 停车场 前后台状态发生变化时需要上传)
     */
